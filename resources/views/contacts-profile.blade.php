                    ...
                    <div class="row">
                        <div class="col-7">
                            <div class="text-primary p-3">
                                <h5 class="text-primary">Setting Your Profile !</h5>
                                {{-- <p>It will seem like simplified</p> --}}
                            </div>
                        </div>
                        {{-- <div class="col-5 align-self-end">
                            <img src="{{ URL::asset('/assets/images/users/avatar-1.jpg') }}" alt="" class="img-fluid">
                        </div> --}}
                    </div>
                </div>
