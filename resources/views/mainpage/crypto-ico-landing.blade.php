...
<head>
    ...
    <meta charset="utf-8" />
    <title>@lang('translation.ICO_Landing') | Arconsult  - Admin & Dashboard Template</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Premium Multipurpose Admin & Dashboard Template" name="description" />
    <meta content="Arconsult " name="author" />
    <!-- App favicon -->
            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <div class="text-white-50">
                        <h1 class="text-white font-weight-semibold mb-3 hero-title">Arconsult  - Ico Landing for a
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <p class="mb-2"><script>document.write(new Date().getFullYear())</script> © Arconsult . Design & Develop by Arconsult </p>
